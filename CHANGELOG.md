...
## [1.7.5] - 2025-11-08
### Fixed
- Upgraded sample Unity project to use 6000.1. Compile-time errors around explicit resolution of UnityEngine.PhysicMaterial have been fixed.

## [1.7.4] - 2025-11-08
### Fixed
- Upgraded sample Unity project to use 2022.3 LTS. Compile-time errors around AudioImporter have been fixed.

## [1.7.3] - 2025-11-08
### Fixed
- Upgraded sample Unity project to use 2019.4 LTS. 
- Properly linked project to package.
